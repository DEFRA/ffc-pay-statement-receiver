const { statementsEndpoint } = require('../../app/config')
...
describe('API', () => {
  ...
  test.each([
    ...
    expect(wreck.get).toHaveBeenCalledWith(`${statementsEndpoint}${url}`, { headers: { Authorization: expectedAuthVal }, json: true })
  ...
  test.each([
    ...
    expect(wreck.post).toHaveBeenCalledWith(`${statementsEndpoint}${url}`, {
